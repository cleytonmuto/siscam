...
function Titulos(){
  ...
  return(
    ...
    <div className='container-fluid' style={{"borderRadius":"25px","margin":"1em","height":"100%", "width": "98%", "padding": "20px", "backgroundColor":"#Fbfbfb","justifyContent":"center" }}>
    {dadosTitulos.length > 0 && (<table className='table table-striped table-hover' style={{"backgroundColor":"#Fbfbfb", "borderRadius":"25px"}}>
      <thead>
        <tr>
