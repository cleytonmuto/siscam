...
import AdvogadoForm from '../components/advogado/AdvogadoForm.js';
        ...
        <div className={styles.advogado_details}>
            <h1>{advogado.nome}</h1>
                {!mostraAdvogadoForm ? (
                    ...
                    <div className={styles.advogado_info}>
                        <AdvogadoForm handleSubmit={editPost} btnText="Concluir edição" advogadoData={advogado}></AdvogadoForm>
                    </div>
                )}
